...
public class negativetestcases
{
    ...
    public void testlinkedlist()
    {
        ...
        node=l.utility1();
        Assert.assertEquals(node.key,2); //after swapping 1st value will be 6
        node=node.next;
        ...
        Assert.assertEquals(node.key,0); //last value will be 1
    }
    @Test
    public void testlinkedlist1()
    {
        ...
        node=l1.utility2();
        Assert.assertEquals(node.key,1); //after poping 1st element, my front is 2
        for (int j=0;j<2;j++)
        {
            node=node.next;
        }
        Assert.assertEquals(node.key,0); //After poping from 2nd posiotio, after front and back my 2nd element is 5
        while (node.next!=null)
        {
            node=node.next;
        }
        Assert.assertEquals(node.key,0); //After poping from back, my last is 5
    }
    @Test
    ...
    public void testCircularlist()
    {
        ...
        node=cl.utility3();
        node1=cl.utility3();
        Assert.assertEquals(node.key,0); //first element after poping
        while (node.next!=node1)
        {
            node=node.next;
        }
        Assert.assertEquals(node.key,0);
    }
    @Test
    ...
    public void testQueue2()
    {
        ...
        Queue2.display();
        Assert.assertEquals(a,0); //front element
